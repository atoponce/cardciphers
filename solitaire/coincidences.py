...
plaintext = "JELLY LIKE ABOVE THE HIGH WIRE SIX QUAKING PACHYDERMS KEPT THE CLIMAX OF THE EXTRAVAGANZA IN A DAZZLING STATE OF FLUX"
plaintext *= 5200
...
for char in keyphrase:
    c.mix_deck(deck, encoder.clist.index(char)+1)
